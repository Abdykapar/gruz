            ...
            <div class="col-md-11">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="col-md-6">
                             <form class="form-inline" method="post" action="{{ route('add_load') }}">
                            {{ Form::token() }}
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control input-lg" id="telephone" name="telephone" placeholder="Введите телефон" style="min-width: 300px; width: 300px;">
                            </div>
                            <br/><br/>
                                 <div class="form-group">
                                 ...
                                 <div class="form-group">
                                     <input type="number" class="form-control input-lg" id="volume" name="volume" placeholder="Тонна" style="min-width: 300px; width: 300px;">
                                 </div>
                                 <br/><br/>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <textarea class="form-control" id="comments" name="description" placeholder="Введите описание" rows="4" style="font-size: 18px; min-width: 300px; width: 300px;"></textarea>
                            </div>
                            <br/><br/>
                            <div class="col-md-7">
                                <button type="submit" class="btn btn-warning btn-lg" style="float: right;margin-right: 60px;">
                                    <span class="glyphicon glyphicon-upload"></span> Create</button>
                            </div>
                        </form>
                        </div>
                        <div class="col-md-6">
