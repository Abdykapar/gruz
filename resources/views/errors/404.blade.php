...
<html lang="en">
<head>
<title>Swanky Error Page a Flat Responsive Widget Template :: w3layouts</title>
...
<!-- /css -->
<!-- js files -->
<script src="/error/js/modernizr.custom.js"></script>
<!-- /js files -->
</head>
<body>
...
<div class="container-w3layouts agileinfo w3-agileits agileits-w3layouts w3-agile">
	<svg version="1.1" viewbox="0 0 800 400">
		...
		<image xlink:href="/error/images/content.jpg" clip-path="url(#my-path)" width="100%" height="100%" id="filler" preserveAspectRatio="none" />
	</svg>
</div>      
<p class="error-agileits wthree">Sorry! This Page Doesn't Exist.</p>
<p class="copyright agile">© 2016 Swanky Error Page. All Rights Reserved | Design by <a href="https://w3layouts.com/" target="_blank">W3layouts</a></p>
</body>
</html>
