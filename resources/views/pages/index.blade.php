...
<div class="container-fluid" style="padding-left: 0px; padding-right: 0px; background-color: #06d66e;">
	<div class="row">
		<div class="col-md-8 col-md-offset-2" style="margin-top: 60px; margin-bottom: 60px; text-align: center;">
			<p style="font-size: 30px; color: #fff; font-weight: 700;">Перевозка.kg - НАЙТИ ПОПУТЧИКА</p>
			...
			<div class="col-md-4" style="text-align: center;">
				...
				<p style="color: #fff; font-size: 25px; font-family: OpenSans-CondBold; line-height: 25px; margin-top: 20px;">Через мобильное приложение Перевозка.kg</p>
			</div>
		</div>
	</div>
</div>
	...
	<div style="min-width: 100%; min-height: 720px; background: rgba(43,71,86,.55);">
		<div class="row">
			<div class="col-md-8 col-md-offset-2" style="margin-top: 60px; text-align: center;">
				<p style="font-size: 30px; color: #fff; font-weight: 700; margin-bottom: 40px;">ЦИФРЫ И ФАКТЫ О Перевозка.kg</p>
		...
		<div class="row">
			<div class="col-md-12" style="margin-top: 40px; margin-bottom: 40px;">
				...
				<div class="col-md-8" style="text-align: left;">
					<p style="font-size: 40px; color: #000; font-weight: 600;">Перевозка.kg — <span style="font-weight: 400;">мобильное приложение для заказа</span> такси в Бишкеке</p>
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2" style="margin-top: 60px; text-align: center; margin-bottom: 40px;">
					...
					<div class="col-md-6" style="text-align: left;">
						<p style="font-size: 25px; color: #fff; font-weight: 600;">Сервис Перевозка.kg для Вас если:</p>
					...
					<div class="col-md-6" style="text-align: left;">
						<p style="font-size: 25px; color: #fff; font-weight: 600;">С помощью сервиса Перевозка.kg вы сможете:</p>
						<p style="color: #fff; font-size: 21px; font-family: OpenSans-Semibold; line-height: 21px; margin-top: 25px;">
							...
							Команда Перевозка.kg постарается сделать все возможное для того, чтобы Вы нашли себе подходящего попутчика,
					...
					<div class="panel panel-primary" style="margin-bottom: 30px;">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordion" href="#collapse1" style="font-size: 21px; color: #fff; font-weight: 600; font-family: OpenSans-Semibold; line-height: 21px; ">КАК ВЫЗВАТЬ ВОДИТЕЛЯ Перевозка.kg?</a>
							</h4>
						</div>
						<div id="collapse1" class="panel-collapse collapse in">
							<div class="panel-body" style="font-size: 21px; color: #000; font-weight: 400; font-family: OpenSans-Semibold; line-height: 21px; ">Вызов водителей Перевозка.kg доступен через приложение. Вам больше не нужно звонить оператору и
								объяснять куда и как доехать. Если у Вас телефон на базе Android, просто загрузите приложение Перевозка.kg с <a href="#">Play Market</a>.
								Для пользователей iOS, приложение Перевозка.kg в <a href="#">App Store</a></div>
						</div>
						<div class="panel panel-primary">
							<div class="panel-heading">
								<h4 class="panel-title">
									<a data-toggle="collapse" data-parent="#accordion" href="#collapse2" style="font-size: 21px; color: #fff; font-weight: 600; font-family: OpenSans-Semibold; line-height: 21px; ">КАК СТАТЬ ВОДИТЕЛЕМ Перевозка.kg?</a>
								</h4>
							</div>
							<div id="collapse2" class="panel-collapse collapse in">
								<div class="panel-body" style="font-size: 21px; color: #000; font-weight: 400; font-family: OpenSans-Semibold; line-height: 21px; ">Всё больше и больше водителей присоединяются к нашей команде. Вы также можете стать водителей Перевозка.kg.</div>
							</div>
...
<div class="container-fluid" style="padding-left: 15px; padding-right: 15px; background-color: #2b4756;">
	<div class="row" style="margin-left: 0px !important; margin-right: 0px !important;">
		<div class="col-md-12" style="min-height: 50px; padding-top: 16px;">
			<span style="color: #fff; font-family: OpenSans-Semibold; font-size: 16px;">©2017 Перевозка.kg Все права защищены.</span>
		</div>
	</div>
</div>
